...
# TODO: 
esp32_supply_voltage = 3.30 # Need to actually measure this on the fly
...
def check_aux1_voltage():
    ...
    if aux1_voltage > 9.5:
        aux1_voltage = aux1_voltage * 1.05
    elif aux1_voltage > 9.7:
        aux1_voltage = aux1_voltage * 1.05
    elif aux1_voltage > 10.2:
        aux1_voltage = aux1_voltage * 0.989
    elif aux1_voltage > 10.7:
        aux1_voltage = aux1_voltage * 0.989
    elif aux1_voltage > 11.2:
        aux1_voltage = aux1_voltage * 0.989
    elif aux1_voltage > 11.7:
        aux1_voltage = aux1_voltage * 0.989
    elif aux1_voltage > 12.2:
        aux1_voltage = aux1_voltage * 0.984
    elif aux1_voltage > 12.7:
        aux1_voltage = aux1_voltage * 0.975
    elif aux1_voltage > 13.2:
        aux1_voltage = aux1_voltage * 0.975
    elif aux1_voltage > 13.7:
        aux1_voltage = aux1_voltage * 0.975
    elif aux1_voltage > 14.2:
        aux1_voltage = aux1_voltage * 0.975
    elif aux1_voltage > 14.7:
        aux1_voltage = aux1_voltage * 0.975
    elif aux1_voltage > 15.2:
        aux1_voltage = aux1_voltage * 0.975
    elif aux1_voltage > 15.7:
        aux1_voltage = aux1_voltage * 0.975
...
def check_aux2_voltage():
    ...
    print("RAW AUX 2 Voltage: ", aux2_voltage)

    if aux2_voltage < 10.0:
        aux2_voltage = aux2_voltage * 1.03
    elif aux2_voltage < 10.33:
        aux2_voltage = aux2_voltage * 1.017
    elif aux2_voltage < 10.65:
        aux2_voltage = aux2_voltage * 1.024
    elif aux2_voltage < 11.07:
        aux2_voltage = aux2_voltage * 1.019
    elif aux2_voltage < 11.64:
        aux2_voltage = aux2_voltage * 1.011
    elif aux2_voltage < 12.2:
        aux2_voltage = aux2_voltage * 1
    elif aux2_voltage < 12.8:
        aux2_voltage = aux2_voltage * 0.986
    elif aux2_voltage < 13.2:
        aux2_voltage = aux2_voltage * 0.979
    elif aux2_voltage < 13.7:
        aux2_voltage = aux2_voltage * 0.979
    elif aux2_voltage < 13.8:
        aux2_voltage = aux2_voltage * 0.97
    elif aux2_voltage < 14.33:
        aux2_voltage = aux2_voltage * 0.95
    elif aux2_voltage < 15.3:
        aux2_voltage = aux2_voltage * 0.925
    elif aux2_voltage < 15.6:
        aux2_voltage = aux2_voltage * 0.91
    elif aux2_voltage < 16.45:
        aux2_voltage = aux2_voltage * 0.89
    elif aux2_voltage < 17.0:
        aux2_voltage = aux2_voltage * 0.88
...
# Kick this thing off
aux2.value(1) # enable the Aux battery to initially power everything
while True:  
